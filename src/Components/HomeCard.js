    ...
    <div className='home-card-container'>
      <div className='home-card-header'>
          <div className='intro-container'>
              <img className="profile-photo" src="https://media.istockphoto.com/photos/futuristic-conceptual-photo-startup-concept-rocket-takeoff-and-from-picture-id1335358427?b=1&k=20&m=1335358427&s=170667a&w=0&h=8KCRoT4MfPUkiqGf4-8--fSXnzR1KMK3--YXWL5Dqew="alt='Profile img'/>
              <div>
                  <h5>jacobs</h5>
                  <span className=''>roteal</span>
              </div>
          </div>
          <span className=''>...</span>
      </div>
